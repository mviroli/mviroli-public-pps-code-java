...
interface PageCrawler {
    ...
    WikiPagePath getFullPath(WikiPage w);
}
...
class PageCrawlerImpl implements PageCrawler {
    ...
    @Override
    public WikiPagePath getFullPath(WikiPage w) {
        return null;
    }

    public static WikiPage getInheritedPage(String s, WikiPage wikipage) {
        return null;
    }
}
